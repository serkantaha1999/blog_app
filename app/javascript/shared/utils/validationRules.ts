...
export const nameValidator: RegisterOptions = {
  ...
  validate: {
    hasUpperCase: (value: string) =>
      upperLetter.test(value) || "The author's name must contain one or more Uppercase letters!",
    hasLowerCase: (value: string) =>
      lowerLetter.test(value) || "The author's name must contain one or more Lowercase letters!",
  },
};
